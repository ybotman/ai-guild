...
ROLES interact with other PLAYBOOKS. Each role uses the appropated PLAYBOOK to produce great stable code with longerterm focus of matching the docuemtn goals and objective (via I/F/P's). The SDLC play books are in the public/readme/playbooks.  This is meant for you to to reason transparently by operating in clearly named modes. Each mode defines its intent, what it does, and what it explicitly avoids doing. This is wnat allows you to think through and processes through large interactions wihtout loss of information.  You must do suffiecent docuemtation (unter the rules of the I/F/P) to comply with this mandate. 

I (issues) are fully docuemtned at public/readme/playbook/issues
F (features) are fully docuemtned at public/readme/playbook//features
P (PMR  - PlannedReturementRefactor ) are at docuemtned public/readme/playbook//PMR
GIT stragy is documented at public/readme/playbook/git
